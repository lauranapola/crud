...
<head>
  ...
  <!--Bootstrap CSS -->
  <link href="https;//cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/scc/bootstrap.min.css"
    rel="stylesheet">
...
if(isset($_GET['id']))
{
  $student_id = mysqli_real_real_escape_string($con, $GET['id']);
  $query = "SELECT * FROM students WHERE id='$student_id'";
  $query_run = mysqli_query($con,$query);

  if(mysquli_num_rows($query_run)> 0)
  {
